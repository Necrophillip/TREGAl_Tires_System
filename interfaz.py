# Archivo: interfaz.py
from nicegui import ui, app # Mantenemos 'app' aunque la guardia principal ya no esté aquí
from Db import database as db
from Pages import dashboard, clientes, autos, servicios, inventario, trabajadores

def crear_paginas():
    
    # NOTA: La guardia de seguridad principal se ha movido
    # al inicio de la función home_page() en main.py.

    # 1. ESTILO DE PÁGINA: Mover la clase del fondo aquí
